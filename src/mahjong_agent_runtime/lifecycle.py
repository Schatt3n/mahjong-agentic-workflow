...
"""Context lifecycle management for the agent loop."""
...
class ContextLifecycleManager:
    """Build, trace, compress, and summarize model context.

    The agent loop asks this component for context; it does not need to know how
    checkpoints are created, when old turns are pruned, or how prompt tokens are
    estimated.
    """
    ...
    def build_and_trace_context(
        ...
        *,
        ...
        """Build model context and write trace artifacts needed for replay."""
    ...
    def summarize_and_rebuild_context_if_needed(
        ...
        *,
        ...
        """Summarize before the main model call when prompt budget is under pressure."""
    ...
    def maybe_summarize_after_turn(self, *, conversation_id: str, trace_id: str) -> ContextSummaryResult | None:
